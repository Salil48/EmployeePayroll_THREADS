...
namespace Employee_Payroll_system_MSTest
{
    ...
    public class Tests
    {
        ...
        public List<EmployeeDetails> AddingDataToList()
        {
            ...
            employeeDetails.Add(new EmployeeDetails(EmployeeID: 32, EmployeeName: "Lee", PhoneNumber: "8888888888", Address: "xayz", Department: "abcd", Gender: 'M', BasicPay: 50000, Deductions: 2000, TaxablePay: 48000, Tax: 1000, NetPay: 47000, City: "pqsr", Country: "defg"));
            employeeDetails.Add(new EmployeeDetails(EmployeeID: 33, EmployeeName: "Sachin", PhoneNumber: "9999999988", Address: "axyz", Department: "abc", Gender: 'M', BasicPay: 25000, Deductions: 1000, TaxablePay: 24000, Tax: 1000, NetPay: 23000, City: "pqrs", Country: "defg"));
            ...
            employeeDetails.Add(new EmployeeDetails(EmployeeID: 35, EmployeeName: "Mahendar", PhoneNumber: "9998899999", Address: "xyzd", Department: "abcd", Gender: 'M', BasicPay: 25000, Deductions: 1000, TaxablePay: 24000, Tax: 1000, NetPay: 23000, City: "pqr", Country: "defg"));
            employeeDetails.Add(new EmployeeDetails(EmployeeID: 36, EmployeeName: "Singh", PhoneNumber: "9988999999", Address: "xydz", Department: "abc", Gender: 'M', BasicPay: 25000, Deductions: 1000, TaxablePay: 24000, Tax: 1000, NetPay: 23000, City: "pqsr", Country: "defg"));
